...
export default function TopBar() {
  ...
  return (
    <div className='top'>
      ...
      <i className='topIcon' class="fab fa-facebook-square"></i>
      <i className='topIcon' class="fab fa-twitter-square"></i>
      <i className='topIcon' class="fab fa-pinterest-square"></i>
      <i className='topIcon' class="fab fa-instagram-square"></i>
      </div>
      ...
      <div className="topRight">
        {
          ...
          <img className='topImg' src={PF+user.profilePic} alt="pix" /> 
          </Link>)
          : (
            <ul className="topList">
            <li className="topListItem">
